  ...
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) { // Got an error!
      ...
      L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
        mapboxToken: 'pk.eyJ1IjoicGdlbmRvdHRpIiwiYSI6ImNrMXF1N253MzAwd3EzYnQwdXJ4dHVtOGYifQ.9hLhF87HMZB5sbqOMxK95Q',
        maxZoom: 18,
...
fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  const altText = DBHelper.imageAltForRestaurant(restaurant)
...
createReviewHTML = (review) => {
  ...
  rating.innerHTML = `Rating: ${'<em>&#9733;</em>'.repeat(review.rating)}`;
